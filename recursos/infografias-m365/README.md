...
Una carpeta por infografía, nombrada con el ID de mensaje `MCxxxxxxx`. La **fecha de publicación** se indica en el README de cada pieza.

```
infografias-m365/
└── MCxxxxxxx-tema/
    ├── *.png   · *.pdf   · *.html
    └── README.md   (ficha + fecha de publicación)
```

## 🗂️ Índice

| Infografía | Publicado |
|---|---|
| **[Planner llega al chat de Copilot (MC1443523)](MC1443523-planner-copilot-chat/)** | 31 jul 2026 |

---

> Solo se utiliza información pública del anuncio oficial del Centro de mensajes. Sin datos internos ni inferencias.
